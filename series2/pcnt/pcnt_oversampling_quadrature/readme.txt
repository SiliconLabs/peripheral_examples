...
7. Observe LED0 toggles on to indicate an overflow; with hysteresis, count is 
   reloaded with TOP/2 = 5 for this example
8. Repeat steps 3-5 for a total of 6 presses/releases (presses + releases = 6)
9. Observe LED0 toggles on to indicate an overflow; with hysteresis, count is 
   reloaded with TOP/2 = 5 for this example
...
Peripherals Used:
LFRCO - 32768 Hz - Used temporarily for configuring PCNT peripheral
