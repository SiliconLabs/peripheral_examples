/***************************************************************************//**
 * @file main_xg27_pdm_stereo_ldma.c
...
void initPdm(void)
{
  ...
  GPIO_PinModeSet(gpioPortC, 7, gpioModePushPull, 1);    // MIC_EN
  GPIO_PinModeSet(gpioPortB, 0, gpioModePushPull, 0);    // PDM_CLK
  GPIO_PinModeSet(gpioPortB, 1, gpioModeInput, 0);       // PDM_DATA

  GPIO_SlewrateSet(gpioPortB, 1, 7);
