 ...
 * pulls the input voltage to GND, and the comparator output low. The
 * comparator output is routed to a GPIO EXP_HEADER14. The MCU core is in
 * sleep mode in EM3, but the analog comparator remains running.
 *
 ******************************************************************************
 * @section License
