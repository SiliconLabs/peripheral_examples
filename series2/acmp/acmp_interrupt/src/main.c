 ...
 * button 1 (PD03) to the 1.25V internal VREF; if the button is pushed, this
 * pulls the input voltage to GND, and the comparator output low. The MCU core
 * is in sleep mode in EM3, but the analog comparator remains operating. In this
 * project, the analog comparator generates an edge interrupt that wakes the MCU,
 * and a GPIO EXP_HEADER14 (PA06) is toggled in the interrupt handler before
 * returning to EM3.
 *
 ******************************************************************************
 * @section License
