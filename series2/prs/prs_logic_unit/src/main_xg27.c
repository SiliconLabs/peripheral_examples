...
#define PRS_OUTPUT_PORT   gpioPortC
...
void initGpio(void)
{
  ...
  // Set PC03 as output
  GPIO_PinModeSet(PRS_OUTPUT_PORT, PRS_OUTPUT_PIN, gpioModePushPull, 0);
}
...
void initPrs(void)
{
  ...
  // Route output to PC03
  PRS_PinOutput(PRS_CH_A, prsTypeAsync, PRS_OUTPUT_PORT, PRS_OUTPUT_PIN);
...
int main(void)
{
  ...
  // Setup PRS to route to output PC03
  initPrs();
