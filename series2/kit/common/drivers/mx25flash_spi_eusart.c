...
void MX25_init( void )
{
   ...
   EUSART_SpiAdvancedInit_TypeDef initAdvanced = EUSART_SPI_ADVANCED_INIT_DEFAULT;

   CMU_ClockEnable( cmuClock_GPIO, true );
   CMU_ClockEnable( MX25_EUSART_CLK, true );

   init.master  = true;
   init.bitRate = MX25_BAUDRATE;
   init.advancedSettings = &initAdvanced;
   initAdvanced.autoCsEnable = false;
   initAdvanced.msbFirst = true;
   EUSART_SpiInit( MX25_EUSART, &init );
...
void MX25_deinit( void )
{
  ...
  CMU_ClockEnable( MX25_EUSART_CLK, false );
}
