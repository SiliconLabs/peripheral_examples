...
#define BSP_STK
#define BSP_WSTK
#define BSP_WSTK_BRD4270B

#define BSP_BCC_USART         EUSART1
#define BSP_BCC_USART_INDEX   1
#define BSP_BCC_CLK           cmuClock_EUSART1
