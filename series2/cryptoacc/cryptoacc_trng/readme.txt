...
This example uses the CRYPTOACC module in the EFR32 Series 2 to generate the
random number.
...
VCOM serial port console. It can use to check the performance against 
cryptoacc_entropy example.
