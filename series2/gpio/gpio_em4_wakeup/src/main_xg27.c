...
#define ESCAPE_HATCH_PORT  gpioPortC
...
void initGPIO(void)
{
  ...
  // Configure PC03 as input for the escape hatch
  GPIO_PinModeSet(ESCAPE_HATCH_PORT, ESCAPE_HATCH_PIN, gpioModeInputPull, 1);
...
int main(void)
{
   ...
   *************************************************************************/
  if (GPIO_PinInGet(ESCAPE_HATCH_PORT, ESCAPE_HATCH_PIN) == 0)
  {
  ...
  {
    GPIO_PinModeSet(ESCAPE_HATCH_PORT, ESCAPE_HATCH_PIN, gpioModeDisabled, 0);
  }
