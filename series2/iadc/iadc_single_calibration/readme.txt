...
5.  Run the example
6.  Using a precision voltage source, supply full scale positive voltage across differential positive
    and negative inputs (see below);
    This example uses AVDD (3.30V) as the reference voltage; 3.30V should be applied to positive input
    and 0.0V should be applied to negative input
7.  Once the power source is connected, press and release PB0
8.  Remove the power source from differential inputs and jumper the two pins to apply a zero volt potential
...
11. Remove the jumper from across the differential inputs, and connect a variable voltage source (source 
