 ...
 * while asleep and setting the oversampling field to achieve
 * a 16-bit resolution conversion. Sample clock is 10MHz, and oversamplign rate
 * is 32. This give a sampling frequency of about 77kHz. The ADC reads GPIO pins
 * PC4 (P25 on BRD4001 J102) as input.
 * @version 0.0.1
 ******************************************************************************
 * @section License
