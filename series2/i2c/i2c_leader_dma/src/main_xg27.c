 ...
 *
 * Upon success, LED1 is toggled and the device re-enters the while
...
// I2C pins (SCL = PB2/EXP15; SDA = PB3/EXP16)
...
void initGPIO(void)
{
  ...
  // Configure LED1 as an output (polarities reversed on BRD4194A)
