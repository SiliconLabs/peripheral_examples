...
This project shows how to use the Cryotimer in EM4 with the LFXO and GPIO
...
2. The board will then enter EM2 and wait for the user to push button 0 to
   trigger an interrupt that will wake the board up from EM2. After being woken
   up from EM2, LED0 will be turned on and LED1 will be turned off. Then, the
   Cryotimer will be enabled and the board will enter EM4. However, since GPIO
   retention is turned on, LED0 will still be on in EM4.
