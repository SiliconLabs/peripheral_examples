...
1. LED0 will be turned on.
2. After 2 seconds, both LEDs will be turned off.
3. After 2 seconds, both LEDs will be turned on.
...
1. Upon reset, the code will always turn LED0 on. Since the board was reset
   ...
   turned off. Then, the board will then enter EM3 and wait for the Cryotimer
...
1. Upon reset, LED0 will be turned on.
2. After 2 seconds, both LEDs will be turned off.
3. After 2 seconds, both LEDs will be turned on.
4. Until a reset is triggered, go back to step 2
