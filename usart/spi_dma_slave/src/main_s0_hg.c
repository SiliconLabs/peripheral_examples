...
/**************************************************************************//**
 * @brief
 *    Initialize the DMA module to transfer packets back to master after each
 *    received packet, data is loaded into the USART TX register whenever there
 *    is room, which is monitored through the TXBL flag
 *
 * @note
