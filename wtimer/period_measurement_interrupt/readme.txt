...
This project demonstrates period measurement using the WTIMER module. WTIMER0 is
initialized for input capture on Compare/Capture channel 0 for falling edge 
capture and interrupts. GPIO Pin PC10 (Expansion Header Pin 16) is to be 
...
2. Connect a periodic signal to GPIO Pin PA0
