...
static void setupPcnt(void)
{
  ...
  pcntInit.counter   = 5;                        // Initial value of counter, intterupt every 6 BTN0 press
  pcntInit.top       = 5;                        // reload value of counter
...
/***************************************************************************//**
 * @brief PRS setup
 *        This function sets up GPIO PRS pin 8 which links BTN0 and PCNT0 PRS0
 *******************************************************************************/        
