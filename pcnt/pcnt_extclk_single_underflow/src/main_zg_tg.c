 ...
 *        This function initializes pulse counter 0 and set up the external
...
static void setupPcnt(void)
{
  ...
  pcntInit.top      = 5;                        // Underflow after every 6th press
 ...
 *        This function enables PCNT0 intererupt request in the
