...
for a voltage greater than 1.25V on this input pin (see below for which pin).

How To Test:
1. Build the project and download to the Starter Kit
2. Provide input pin with voltage less than 1.25V and watch LED0 turn on
...
ACMP0 input Ch 4 - Expansion Header Pin 3 (PC4)

Board:  Silicon Labs EFM32GG Starter Kit (STK3700A)
Device: EFM32GG990F1024
ACMP0 input Ch 0 - Expansion Header Pin 3 (PC0)
...
ACMP0 input - Expansion Header Pin 13 (PB9)

Board:  Silicon Labs EFM32TG11 Starter Kit (SLSTK3301A)
Device: EFM32TG11B520F128GM80
ACMP0 input - Expansion Header Pin 3 (PC0)
