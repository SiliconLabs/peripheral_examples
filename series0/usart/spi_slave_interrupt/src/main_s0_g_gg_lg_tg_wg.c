...
#define US1MISO_PORT  gpioPortD
#define US1MISO_PIN   1
#define US1MOSI_PORT  gpioPortD
#define US1MOSI_PIN   0
#define US1CLK_PORT   gpioPortD
#define US1CLK_PIN    2
#define US1CS_PORT    gpioPortD
#define US1CS_PIN     3
#define US1LOCATION   1
...
void initUSART1(void)
{
  ...
  USART1->ROUTE = USART_ROUTE_RXPEN | USART_ROUTE_TXPEN  |
                  ...
                  (US1LOCATION << _USART_ROUTE_LOCATION_SHIFT);
