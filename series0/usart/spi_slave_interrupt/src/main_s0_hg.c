...
#define US0MISO_PORT  gpioPortE
#define US0MISO_PIN   11
#define US0MOSI_PORT  gpioPortE
#define US0MOSI_PIN   10
#define US0CLK_PORT   gpioPortE
#define US0CLK_PIN    12
#define US0CS_PORT    gpioPortE
#define US0CS_PIN     13
#define US0LOCATION   0
...
void initUSART0(void)
{
  ...
  USART0->ROUTE = USART_ROUTE_RXPEN | USART_ROUTE_TXPEN  |
                  ...
                  (US0LOCATION << _USART_ROUTE_LOCATION_SHIFT);
...
void USART0_RX_IRQHandler(void)
{
  ...
  GPIO->P[TIMEPORT].DOUTSET = (1 << TIMEPIN);
  ...
  GPIO->P[TIMEPORT].DOUTCLR = (1 << TIMEPIN);
}
