/***************************************************************************//**
 * @file main.c
 * @brief This project demonstrates the use of the TIMER module for polled input
 * capture. The Compare/Capture channel interrupt flag is polled until Push
 * Button 0 is pressed. The PRS then routes this signal to the timer to indicate
 * that an input capture needs to occur. The captured timer value is then stored
