...
is routed to a GPIO pin. The TOP value register is set such that on each 
overflow, the output toggles at the desired frequency.
...
(19 * 10^6) / (2 *65535 * 1) = 145Hz for series 1 boards. For series 0 boards, 
it is (14 * 10^6) / (2 *65535 * 1) = 107Hz by default.

================================================================================

Peripherals Used:
HFRCO  - 19 MHz (for series 1) and 14 MHz (for series 0)
TIMER0 - CC0
...
2. Use an oscilloscope to measure the waveform on the GPIO pin specified below
