/***************************************************************************//**
 * @file main_s0.c
 * @brief This project uses the CTR (Counter) mode of AES encryption to encrypt
 * the user's input data and then decrypt it.
 *******************************************************************************
 * # License
...
int main(void)
{
  ...
  AES_CTR256(encryptedData,       // Pointer to buffer where encrypted/decrypted data will be put
  ...
  // Note: the encryption and decryption operations are identical in CTR mode
  AES_CTR256(decryptedData,       // Pointer to buffer where encrypted/decrypted data will be put
