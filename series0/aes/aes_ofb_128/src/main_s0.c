/***************************************************************************//**
 * @file main_s0.c
 * @brief This project uses the OFB (Output Feedback) mode of AES encryption to
 * encrypt the user's input data and then decrypt it.
 *******************************************************************************
 * # License
...
int main(void)
{
  ...
  // Encrypt data using AES-128 OFB
  // Note: the encryption and decryption operations are identical in OFB mode
  AES_OFB128(encryptedData, // Pointer to buffer where encrypted/decrypted data will be put
  ...
  // Decrypt data using AES-128 OFB
  // Note: the encryption and decryption operations are identical in OFB mode
  AES_OFB128(decryptedData, // Pointer to buffer where encrypted/decrypted data will be put
