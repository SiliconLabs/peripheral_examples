...
int main(void)
{
  ...
  AES_ECB128(encryptedData, // Pointer to buffer where encrypted/decrypted data will be put
  ...
  AES_ECB128(decryptedData, // Pointer to buffer where encrypted/decrypted data will be put
