...
through the prs.  Completed conversions are handled by the DMA, and the 
results are stored in global variables.

Note: The values read from the ADC are not converted to mV.  To do so,
use the equation:
  mV = (raw * 2500) / 4096

Note: You might get one transfer automatically in the beginning.  This is due
to the fact that the push buttons are high when not pressed, so they send an
interrupt signal by default.  This can normally be fixed by telling the PRS to
watch for rising or falling edges, but this cannot be done in asynchronous
mode (which is required for EM2).
...
Request Input - PB9 - PRS Channel 0 (Push Button 0)
Analog Input - PD7 - ADC0 Channel 7 (Expansion Header Pin 15)

Board:  Silicon Labs EFM32GG Starter Kit (STK3700)
Device: EFM32GG990F1024
Request Input - PB9 - PRS Channel 0 (Push Button 0)
Analog Input - PD7 - ADC0 Channel 7 (Expansion Header Pin 17)

Board:  Silicon Labs EFM32HG Starter Kit (SLSTK3400A)
Device: EFM32HG322F64
Request Input - PC9 - PRS Channel 0 (Push Button 0)
Analog Input - PD7 - ADC0 Channel 7 (Expansion Header Pin 15)
...
Request Input - PD8 - PRS Channel 0 (Push Button 0)
Analog Input - PD7 - ADC0 Channel 7 (Expansion Header Pin 15)
...
Analog Input - PD7 - ADC0 Channel 7 (Expansion Header Pin 4)
