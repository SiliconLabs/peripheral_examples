...
the DMA, and the results are stored in global variables.

NOTE: Gecko, Tiny Gecko, Zero Gecko, and Happy Gecko do not have loop 
functionality built into their DMA units, so these examples will only read
DMA_BUFFER_SIZE/NUM_SCAN_INPUTS inputs.
...
Analog Input 1- PD6 - ADC0 Channel 6 (Expansion Header Pin 16)
Analog Input 2- PD7 - ADC0 Channel 7 (Expansion Header Pin 15)

Board:  Silicon Labs EFM32GG Starter Kit (STK3700)
Device: EFM32GG990F1024
Request Input - PB9 - PRS Channel 0 (Push Button 0)
Analog Input 1- PD6 - ADC0 Channel 6 (Expansion Header Pin 16)
Analog Input 2- PD7 - ADC0 Channel 7 (Expansion Header Pin 17)
...
Analog Input 1- PD6 - ADC0 Channel 6 (Expansion Header Pin 6)
Analog Input 2- PD7 - ADC0 Channel 7 (Expansion Header Pin 4)
