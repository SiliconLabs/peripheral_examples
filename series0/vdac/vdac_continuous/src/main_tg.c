 ...
 *
 * @note
 *    For the Tiny Gecko board (TG), we need to ensure that the CH0DATA register
 *    is written to before moving on. This issue only occurs with the Tiny Gecko
 *    board with optimization level 2 (gcc -O2).
 *****************************************************************************/
int main(void)
{
  // Chip errata
  ...
  // Ensure that the value has been written to the CH0DATA register before going into EM3
  while (DAC0->CH0DATA != dacValue) {}
