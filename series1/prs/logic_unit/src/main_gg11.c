...
void initPrs(void)
{
  ...
  // Route PRS output to location 3 (Expansion Header pins)
  PRS_GpioOutputLocation(PRS_BASE_CH, 3);   // PE 12, EH 8
  PRS_GpioOutputLocation(PRS_BASE_CH+1, 3); // PE 13, EH 10
}
