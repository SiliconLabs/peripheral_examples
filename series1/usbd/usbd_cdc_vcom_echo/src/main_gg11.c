/***************************************************************************//**
 * @file main_gg11.c
 * @brief USB CDC example that implements a virtual COM port (VCOM) echo example.
 * Data that is received from the USB host is processed by the USB device and
 * then sent back to the USB host. In this case, the USB host is the computer
 * and the USB device is the EFM32 board.
 *******************************************************************************
 * # License
