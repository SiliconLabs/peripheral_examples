 ...
 * the TX port one line at a time. It idles in EM2. See the readme.txt for
 * details.
 * @version 0.0.1
 ******************************************************************************
 * @section License
...
void initLeuart(void)
{
  ...
  // Enable LEUART0 RX/TX pins on PC[15:14] (see readme.txt for details)
  LEUART0->ROUTEPEN  = LEUART_ROUTEPEN_RXPEN | LEUART_ROUTEPEN_TXPEN;
  LEUART0->ROUTELOC0 = LEUART_ROUTELOC0_RXLOC_LOC5 | LEUART_ROUTELOC0_TXLOC_LOC5;
