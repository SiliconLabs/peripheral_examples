 ...
 * readme.txt is configured for output and outputs a 1kHz, 5% duty cycle signal.
 * The duty cycle can be adjusted by writing to the CCVB or changing the global
 * dutyCyclePercent variable.
 *******************************************************************************
 * # License
