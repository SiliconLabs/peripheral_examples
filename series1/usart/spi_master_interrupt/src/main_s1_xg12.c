...
void initGPIO(void)
{
  ...
  GPIO_PinModeSet(US2MISO_PORT, US2MISO_PIN, gpioModeInput, 0);
...
void initUSART2(void)
{
  ...
  /*
   * Route USART2 RX, TX, and CLK to the specified pins.  Note that CS
...
void USART2_TX_IRQHandler(void)
{
  ...
  USART_IntClear(USART2, USART_IF_TXC);
}
...
int main(void)
{
  ...
  while (1)
  {
    ...
    GPIO_PinOutClear(US2CS_PORT, US2CS_PIN);
    ...
    GPIO_PinOutSet(US2CS_PORT, US2CS_PIN);
