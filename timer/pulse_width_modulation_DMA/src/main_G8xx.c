 ...
 * TIMER module. PD1 (See readme for Exp. pin out) is configured for output and
...
void initTIMER(void)
{
  ...
  // Safely enable TIMER0 CC0 interrupt flags
...
void initDMA(void)
{
  ...
  DMA_ActivatePingPong(0, false, (void *)&(TIMER0->CC[0].CCVB), (void *)&buffer,
     BUFFERSIZE - 1, (void *)&(TIMER0->CC[0].CCVB), (void *)&buffer, BUFFERSIZE - 1);
}
