...
This project demonstrates period measurement using the TIMER module. TIMER1 is
initialized for input capture on Compare/Capture channel 0 for falling edge 
capture and interrupts. GPIO Pin PD6 (Expansion Header Pin 16)is to be
connected to a periodic signal, and edges captured from PD6 are stored in CC0.
