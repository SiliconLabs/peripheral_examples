...
This project demonstrates using the ADC0 peripheral to take differential-ended
...
ADC     - 16 MHz for Series 1, 13 MHz for Series 0, 12-bit resolution, 
          2.5V internal reference (Note: This means that only differential 
	  voltages between -1.25 to 1.25 mV are accepted)


Board:  Silicon Labs EFM32G Starter Kit (G8xx-STK)
Device: EFM32G890F128
PD6 - ADC0 Channel 6 (Expansion Header Pin 16)
...
PD6 - ADC0 Channel 6 (Expansion Header Pin 6)
...
PA3 - ADC0 Pos Port 4X Channel 11 (Expansion Header Pin 5)
...
PE11- ADC0 Pos Port 4X Channel 11 (Expansion Header Pin 6)
