...
int main(void) 
{
  ...
  while (1) 
  {
    ...
    {
      // LED0 On, the multicolored LEDs on the GG11 work off negative logic
      GPIO_PinOutClear(BSP_GPIO_LED0_PORT, BSP_GPIO_LED0_PIN);
    }
    else
    {
      // LED0 Off, the multicolored LEDs on the GG11 work off negative logic
    ...
    {
      // LED1 Off, the multicolored LEDs on the GG11 work off negative logic
