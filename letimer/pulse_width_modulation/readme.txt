...
This project demonstrates pulse width modulation using the LETIMER. The 
project initializes the timer for PWM with a set 30 percent duty cycle at 1 kHz
frequency. The waveform is output on either Expansion Header Pin 15 or 16 depending on the board.
