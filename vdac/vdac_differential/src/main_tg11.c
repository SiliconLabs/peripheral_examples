 ...
 *
 * @details
 *    This program uses the alternate VDAC output for channel 0 and channel 1
 *****************************************************************************/
void initVdac(void)
{
  ...
  // Disable main output pins because we're not using them
