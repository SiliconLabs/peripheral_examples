...
increment the duty cycle and the other will decrement the duty cycle in 5% increments. 
...
2. Use an oscilloscope to view the 1 KHz signal with 30% duty cycle on the GPIO 
   pin specified below
3. Press the GPIO buttons to see the duty cycle change in increments of 5%
================================================================================
