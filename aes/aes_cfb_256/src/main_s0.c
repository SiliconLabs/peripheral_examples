/**************************************************************************//**
 * @main_series0.c
 * @brief This project uses the CFB (Cipher Feedback) mode of AES
...
int main(void)
{
  ...
  AES_CFB256(encryptedData, // Pointer to buffer where encrypted/decrypted data will be put
             ...
             initVector,    // A 256 bit initialization vector
             true);         // Use encryption mode

  // Decrypt data using AES-256 CFB
  AES_CFB256(decryptedData, // Pointer to buffer where encrypted/decrypted data will be put
