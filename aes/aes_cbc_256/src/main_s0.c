...
int main(void)
{
  ...
  AES_CBC256(encryptedData, // Pointer to buffer where encrypted/decrypted data will be put
  ...
  AES_CBC256(decryptedData, // Pointer to buffer where encrypted/decrypted data will be put
